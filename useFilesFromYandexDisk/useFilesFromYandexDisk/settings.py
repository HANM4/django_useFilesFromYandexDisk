"""
Django settings for useFilesFromYandexDisk project.
...
ROOT_URLCONF = 'useFilesFromYandexDisk.urls'
...
WSGI_APPLICATION = 'useFilesFromYandexDisk.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / "useFilesFromYandexDisk" / "static",
]
STATIC_URL = '/static/'
